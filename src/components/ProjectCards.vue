  ...
  <div>
    ...
    >
      <ul class="ml-4">
        ...
        <li>
          deployment actions like building releases and publishing packages
        </li>
        <li>integration actions like running tests and code quality checks</li>
    ...
    >
      <ul class="ml-4">
        <li>
          creating entry points from functions with class arguments, exposing
          the fields as cli parameters
        </li>
        <li>
